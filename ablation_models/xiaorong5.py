...
class MY_NET(nn.Module):
    ...
    def forward(self,x1,x2):
        ...
        x1_layer3_changed,x2_layer3_changed = self.ce(x1_layer3,x2_layer3)
        x1_layer4 = self.net.net.layer4(x1_layer3_changed)
        x2_layer4 = self.net.net.layer4(x2_layer3_changed)
