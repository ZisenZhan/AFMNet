# 学习单位: 南京信息工程大学
# 学   生: 詹子森
# 开发时间: 2023/9/15 22:46
# 学习单位: 南京信息工程大学
# 学   生: 詹子森
# 开发时间: 2023/9/13 11:08
...
root_path = r'C:\PycharmProjects\pytorch-from book\codes-paper2\datasets\GZ_CDD'
...
class GZCDDDataset(torch.utils.data.Dataset):
